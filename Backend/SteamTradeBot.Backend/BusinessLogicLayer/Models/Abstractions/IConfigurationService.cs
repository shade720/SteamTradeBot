...
public interface IConfigurationService
{
    ...
    /// <summary>
    /// Коэффициент средней цены - лежит в промежутке -1:1 - значение 0 соответствует фактической средней цене из графика, -1 - не берем никакие предметы, 1 - берем все.
    /// </summary>
    ...
    /// <summary>
    /// Коэффициент продаж - лежит в промежутке 0:1 - место в списке цена-продажи (чем больше коэффициент, тем больше будет цена и тем быстрее будут покупаться предметы).
    /// </summary>
